<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投票分类" prop="toupiaofenlei">
          <el-input v-model="ruleForm.toupiaofenlei" 
              placeholder="投票分类" clearable  :readonly="ro.toupiaofenlei"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="票数" prop="piaoshu">
          <el-select :disabled="ro.piaoshu" v-model="ruleForm.piaoshu" placeholder="请选择票数">
            <el-option
