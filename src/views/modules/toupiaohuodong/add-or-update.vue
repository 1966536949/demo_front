  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.toupiaotupian" class="upload" label="投票图片" prop="toupiaotupian">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.toupiaotupian" label="投票图片" prop="toupiaotupian">
              <img v-for="(item,index) in ruleForm.toupiaotupian.split(',')" v-bind:key="index"
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="投票分类" prop="toupiaofenlei">
            <el-select v-model="ruleForm.toupiaofenlei" :disabled="ro.toupiaofenlei" placeholder="请选择投票分类">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="票数" prop="piaoshu">
            <el-input v-model="ruleForm.piaoshu"
                      :readonly="ro.piaoshu" clearable placeholder="票数"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="date" label="日期" prop="riqi">
            <el-date-picker
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.riqi" class="input" label="日期" prop="riqi">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="textarea" label="内容" prop="neirong">
            <el-input
