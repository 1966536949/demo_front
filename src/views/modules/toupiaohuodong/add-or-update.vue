<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投票名称" prop="toupiaomingcheng">
          <el-input v-model="ruleForm.toupiaomingcheng" 
              placeholder="投票名称" clearable  :readonly="ro.toupiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.toupiaotupian" label="投票图片" prop="toupiaotupian">
          <file-upload
          tip="点击上传投票图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.toupiaotupian" label="投票图片" prop="toupiaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.toupiaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="投票分类" prop="toupiaofenlei">
          <el-select :disabled="ro.toupiaofenlei" v-model="ruleForm.toupiaofenlei" placeholder="请选择投票分类">
            <el-option
