  ...
  <div>
    <div class="container">
      <div class="login-form">
        <h1 class="h1">在线投票管理系统注册</h1>
        <el-form ref="rgsForm" :model="rgsForm" class="rgs-form">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="用户名">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="密码">
            <el-input v-model="ruleForm.mima" #elsetype="text" autocomplete="off" placeholder="密码" type="password"/>
          </el-form-item>
          <el-form-item v-if="tableName=='yonghu'" class="input" label="确认密码">
